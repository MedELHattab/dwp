...
const allImages = [
  "/Projet-Librairie-preface-IMG_0970-1170x658.jpg",
  "/IMG_8263-1170x658.webp",
  "/BUREAUX-ARCHI-scaled-800x500.jpg",
  "/YROLmfdQa2zqlwGcAWrlPhNRVk.avif",
  "/fOckIjkgOR7dMVJ4RMB6RsXNzSE.avif",
]

// Create 4 vertical columns with images
const columns = [
  [allImages[0], allImages[3], allImages[1], allImages[4], allImages[2]],
  [allImages[1], allImages[4], allImages[2], allImages[0], allImages[3]],
  [allImages[2], allImages[0], allImages[3], allImages[1], allImages[4]],
  [allImages[3], allImages[2], allImages[4], allImages[0], allImages[1]],
]
...
export function ProductShowcase() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#fffef2] py-20 md:py-32">
